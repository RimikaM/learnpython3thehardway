# -*- coding: utf-8 -*-
"""
Created on Fri Dec 15 22:11:04 2017
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent('''
                     ...
                     the room and find the netron bomb in its container.
        ...
        if guess == code:
            print(dedent('''
                         ...
                         you can to the bridge when you must place it in the
                         right spot.
                         '''))
            return 'the_bridge'
        else:
